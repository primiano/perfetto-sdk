...
class PERFETTO_EXPORT TracePacket : public ::protozero::Message {
 public:
  ...
  class Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/900, /*HAS_REPEATED_FIELDS=*/false> {
   public:
...
class PERFETTO_EXPORT TracingServiceState : public ::protozero::Message {
 public:
  enum : int32_t {
...
class PERFETTO_EXPORT TracingServiceState_DataSource : public ::protozero::Message {
 public:
  enum : int32_t {
  ...
  class Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/2, /*HAS_REPEATED_FIELDS=*/false> {
   public:
    ...
    explicit Decoder(const std::string& raw) : TypedProtoDecoder(reinterpret_cast<const uint8_t*>(raw.data()), raw.size()) {}
    explicit Decoder(const ::protozero::ConstBytes& raw) : TypedProtoDecoder(raw.data, raw.size) {}
    bool has_descriptor() const { return at<1>().valid(); }
    ::protozero::ConstBytes descriptor() const { return at<1>().as_bytes(); }
    bool has_producer_id() const { return at<2>().valid(); }
    int32_t producer_id() const { return at<2>().as_int32(); }
  };
  template <typename T = DataSourceDescriptor> T* set_descriptor() {
    return BeginNestedMessage<T>(1);
  }
...
class PERFETTO_EXPORT TracingServiceState_Producer : public ::protozero::Message {
 public:
  enum : int32_t {
    kIdFieldNumber = 1,
    kNameFieldNumber = 2,
...
class PERFETTO_EXPORT HeapprofdConfig : public ::protozero::Message {
 public:
  ...
  class Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/12, /*HAS_REPEATED_FIELDS=*/true> {
   public:
    Decoder(const uint8_t* data, size_t len) : TypedProtoDecoder(data, len) {}
    explicit Decoder(const std::string& raw) : TypedProtoDecoder(reinterpret_cast<const uint8_t*>(raw.data()), raw.size()) {}
    explicit Decoder(const ::protozero::ConstBytes& raw) : TypedProtoDecoder(raw.data, raw.size) {}
...
#ifndef PERFETTO_PROTOS_PERFETTO_CONFIG_SYS_STATS_SYS_STATS_CONFIG_PROTO_H_
#define PERFETTO_PROTOS_PERFETTO_CONFIG_SYS_STATS_SYS_STATS_CONFIG_PROTO_H_
...
class PERFETTO_EXPORT SysStatsConfig : public ::protozero::Message {
 public:
  enum : int32_t {
...
class PERFETTO_EXPORT TestConfig : public ::protozero::Message {
 public:
  enum : int32_t {
...
class PERFETTO_EXPORT TestConfig_DummyFields : public ::protozero::Message {
 public:
  enum : int32_t {
  ...
  class Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/14, /*HAS_REPEATED_FIELDS=*/false> {
   public:
    Decoder(const uint8_t* data, size_t len) : TypedProtoDecoder(data, len) {}
    explicit Decoder(const std::string& raw) : TypedProtoDecoder(reinterpret_cast<const uint8_t*>(raw.data()), raw.size()) {}
    explicit Decoder(const ::protozero::ConstBytes& raw) : TypedProtoDecoder(raw.data, raw.size) {}
...
class PERFETTO_EXPORT TraceConfig : public ::protozero::Message {
 public:
  ...
  class Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/25, /*HAS_REPEATED_FIELDS=*/true> {
   public:
    Decoder(const uint8_t* data, size_t len) : TypedProtoDecoder(data, len) {}
    explicit Decoder(const std::string& raw) : TypedProtoDecoder(reinterpret_cast<const uint8_t*>(raw.data()), raw.size()) {}
    explicit Decoder(const ::protozero::ConstBytes& raw) : TypedProtoDecoder(raw.data, raw.size) {}
...
class PERFETTO_EXPORT TraceConfig_IncidentReportConfig : public ::protozero::Message {
 public:
  enum : int32_t {
...
class PERFETTO_EXPORT TraceConfig_IncrementalStateConfig : public ::protozero::Message {
 public:
  enum : int32_t {
...
class PERFETTO_EXPORT Trigger : public ::protozero::Message {
 public:
  enum : int32_t {
...
class GpuCounterEvent_GpuCounterSpec;

class PERFETTO_EXPORT GpuCounterEvent : public ::protozero::Message {
 public:
  enum : int32_t {
    kCounterSpecsFieldNumber = 1,
  ...
  class Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/2, /*HAS_REPEATED_FIELDS=*/true> {
   public:
    ...
    explicit Decoder(const std::string& raw) : TypedProtoDecoder(reinterpret_cast<const uint8_t*>(raw.data()), raw.size()) {}
    explicit Decoder(const ::protozero::ConstBytes& raw) : TypedProtoDecoder(raw.data, raw.size) {}
    bool has_counter_specs() const { return at<1>().valid(); }
    ::protozero::RepeatedFieldIterator counter_specs() const { return GetRepeated(1); }
    bool has_counters() const { return at<2>().valid(); }
    ::protozero::RepeatedFieldIterator counters() const { return GetRepeated(2); }
  };
  using GpuCounterSpec = ::perfetto::protos::pbzero::GpuCounterEvent_GpuCounterSpec;
  using GpuCounter = ::perfetto::protos::pbzero::GpuCounterEvent_GpuCounter;
  template <typename T = GpuCounterEvent_GpuCounterSpec> T* add_counter_specs() {
    return BeginNestedMessage<T>(1);
  }
...
class PERFETTO_EXPORT GpuCounterEvent_GpuCounter : public ::protozero::Message {
 public:
  enum : int32_t {
  ...
  class Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/2, /*HAS_REPEATED_FIELDS=*/false> {
   public:
    ...
    bool has_value() const { return at<2>().valid(); }
    int64_t value() const { return at<2>().as_int64(); }
  };
...
class PERFETTO_EXPORT GpuCounterEvent_GpuCounterSpec : public ::protozero::Message {
 public:
  enum : int32_t {
    kCounterIdFieldNumber = 1,
    kNameFieldNumber = 2,
...
class PERFETTO_EXPORT GpuRenderStageEvent : public ::protozero::Message {
 public:
  enum : int32_t {
...
class PERFETTO_EXPORT GpuRenderStageEvent_Specifications : public ::protozero::Message {
 public:
  enum : int32_t {
...
class PERFETTO_EXPORT GpuRenderStageEvent_Specifications_Description : public ::protozero::Message {
 public:
  enum : int32_t {
    kIdFieldNumber = 1,
    kNameFieldNumber = 2,
...
class PERFETTO_EXPORT GpuRenderStageEvent_Specifications_ContextSpec : public ::protozero::Message {
 public:
  enum : int32_t {
...
class PERFETTO_EXPORT GpuRenderStageEvent_ExtraData : public ::protozero::Message {
 public:
  enum : int32_t {
    kNameFieldNumber = 1,
    kValueFieldNumber = 2,
